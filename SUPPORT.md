...
Search existing issues, use the latest supported version, include your environment and exact commands, provide a minimal reproduction, and remove credentials or private data.

Community support is best-effort. Public templates do not include an SLA or project-specific consulting.
